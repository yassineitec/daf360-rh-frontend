...
@Component({
  ...
  template: `
    <div class="bg-white border rounded-xl p-4
                hover:shadow-sm transition-all flex items-center gap-4 relative"
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex flex-wrap gap-4 mt-1">
          ...
          @if (employee().email) {
            <span class="flex items-center gap-1 text-[12px] text-outline max-w-[180px] truncate">
        ...
        <div class="flex gap-1 transition-opacity duration-200"
          ...
          <button
            ...
            class="p-2 rounded-lg border border-outline-variant text-outline
                   hover:text-[#50717B] hover:border-[#50717B] transition-colors"
