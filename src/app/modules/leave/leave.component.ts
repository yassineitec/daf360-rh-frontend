...
@Component({ selector: 'app-leave', standalone: true, template: `
  <div class="page-wrapper">
    <div class="page-header">
      <h1 class="page-title">Gestion des congés</h1>
      <p class="page-subtitle">Absences, télétravail, autorisations</p>
    </div>
    <div class="page-body"><p class="placeholder-text">Module Congés — implémentation à venir.</p></div>
  </div>`,
